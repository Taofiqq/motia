...
When you submits an adoption application, this API immediately responds with confirmation while starting the background process asynchronously.
...
![Background Check Completion](./../img/background-check-completed.png)
...
Home Visit Check 
![Background Check Start](./../img/home-visit-check-start.png)

Home Visit Check Completed
![Background Check Completion](./../img/home-visit-check-completed.png)
...
The decision process uses a weighted scoring system (40% background, 60% home visit) while enforcing that certain criteria must be met regardless of score.