---
title: Build Your First Background Jobs in Motia
...
Now when someone creates a pet, your API will emit a `pet-created` event that background jobs can listen for.
